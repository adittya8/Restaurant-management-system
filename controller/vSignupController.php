...
if (isset($_POST['submit'])) {
  ...
  $birthday =$id= $name = $email = $comment = $website ="";
  $username=$password="";
 $confirmpass="";
 $flag=1;
...
if($flag==1)
{
  ...
  if (addSignupInfo($id, $name, $email, $birthday, $username, $password)) {
...
function addSignupInfo($id, $name, $email, $birthday, $username, $password){
    $query = "INSERT into customer (id, name, email, birth, username, password) VALUES ($id, $name, $email, $birthday, $username, $password)";
    $rs = $query;
